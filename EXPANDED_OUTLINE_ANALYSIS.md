...
2. **System extracts `outline_summary` field** (29 words):
   ...
   ```
3. **Quality check**: 29 < 50 words minimum → FAIL
4. **Fallback**: Use MegaOutline (4033 chars, ~700 words)

### Why This is Not a Bug

✅ **LLM generates valid, detailed ChapterOutlineOutput**
...
✅ **29-word summary is realistic for concise description**
- Captures character journey: Rian (legend → meeting)
...
**Adequate Coverage:**
- ✅ Basic plot direction
- ✅ Character involvement
- ✅ Main conflict identification

**Missing Critical Elements:**
- ❌ **Scene pacing structure** → Number of scenes, flow, transitions
- ❌ **Character development arc** → Emotional journey, growth moments
- ❌ **Foreshadowing setup** → Future event preparation
- ❌ **Literary device guidance** → Symbolism, themes
- ❌ **Scene breakdown** → Where to start/end scenes
...
This ensures:
- ✅ High quality when available (focused + detailed)
- ✅ Guaranteed functionality (fallback protects from poor generation)
- ✅ Graceful degradation (better to use MegaOutline than bad outline)
...
- ✅ Informative warnings for monitoring
...
- If <70% acceptance rate → implement Option 2
